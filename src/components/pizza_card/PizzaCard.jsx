...
const PizzaCard = ({ title, price, description, image, card, setCard, handleSend, key, ...props }) => {
    return (
        <div className={css.pizza_block}>
            ...
            <div className={css.footer}>
                ...
                <button className={css.footer_btn} onClick={() => {
                    handleSend({ title, price, description, image, key})
